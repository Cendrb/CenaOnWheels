 ...
 */
public class BlockKlidLeaves extends BlockBase {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(DECAYABLE, meta % 2 == 1).withProperty(CHECK_DECAY, meta / 2 == 1);
    }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (!worldIn.getBlockState(pos.down()).isFullyOpaque() && rand.nextInt(15) == 1) {
    ...
    public java.util.List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        if (rand.nextInt(chance) == 0)
            ret.add(new ItemStack(ModBlocks.aschSapling, 1, damageDropped(state)));
